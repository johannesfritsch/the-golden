...
const Button = ({ type = 'primary', caption, onClick, disabled = false, style: additionalStyle }: ButtonProps) => {
    return (
        <Pressable onPress={!disabled ? onClick : () => {}} style={[{ backgroundColor: type === 'primary' ? '#B29146' : '#666', width: '100%', paddingHorizontal: 10, paddingVertical: 20, borderRadius: 20 }, additionalStyle]}>
